...
parser.add_argument('--lexNames', nargs='*', type=str, default=['valence', 'arousal','dominance'], help='Names of the lexicons/column names in the lexicon CSV')
parser.add_argument('--savePath', default=r'EmotionDynamics\code\results_to_test', help='Path to save folder')
